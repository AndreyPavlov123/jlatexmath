...
import org.scilab.forge.jlatexmath.android.test.app.R;

import org.scilab.forge.jlatexmath.android.view.JLatexMathView;
...
public class MainActivity extends AppCompatActivity {
    ...
    static {
        if (FactoryProvider.getInstance() == null) {
			FactoryProvider.setInstance(new FactoryProviderAndroid(App.INSTANCE.getApplicationContext()));
		}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jLatexMathView = findViewById(R.id.latex_math_view);
        jLatexMathView.setTextSize(100);
...
//        if (true) {
//            final JLatexMathDrawable drawable = new JLatexMathDrawable.Builder(latex)
//                    .textSize(100)
//                    .fitCanvas(false)
